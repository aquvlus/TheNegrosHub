...
local Window = OrionLib:MakeWindow({Name = "The Negros Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
Tab:AddButton({
	...
	Callback = function()
      		print("button pressed")
              loadstring(game:HttpGet("https://you.whimper.xyz/sources/rb/mm2.lua"))()
    end
})
...
Tab:AddButton({
	...
	Callback = function()
      		print("button pressed")
              loadstring(game:HttpGet("https://pastebin.com/raw/Hw8JszuM"))()
    end
})
...
Tab:AddButton({
	...
	Callback = function()
      		print("button pressed")
              loadstring(game:HttpGet("https://pastebin.com/raw/KGhmxRR5", true))()
    end
})
